...
class ROTARY_API ARotary_Heli : public APawn {
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintGetter)
	URotary_HeliMovementComponent* GetVehicleMovement() const;
...
private:
	...
	URotary_HeliMovementComponent* m_VehicleMovement;

	auto InitSkelMesh() -> USkeletalMeshComponent*;
	auto InitVehicleMovement(USkeletalMeshComponent* mesh) -> URotary_HeliMovementComponent*;
