 ...
 */
UCLASS(NotBlueprintable, MinimalAPI, meta=(DisplayName="Rotary Decayed Release"))
class UInputTrigger_Rotary_DecayedRelease : public UInputTrigger {
	GENERATED_BODY()

public:
	UInputTrigger_Rotary_DecayedRelease(FObjectInitializer const& init);
