...
#define Self ARotary_Heli


// Initialization --------------------------------------------------------------

Self::ARotary_Heli() : Super()
{
...
auto Self::InitVehicleMovement(USkeletalMeshComponent* mesh) -> URotary_HeliMovementComponent*
{
	auto* cmp = CreateDefaultSubobject<URotary_HeliMovementComponent>(TEXT("VehicleMovement"));
...
auto Self::GetVehicleMovement() const -> URotary_HeliMovementComponent*
{
