...
#include "Rotary_RetainerBox.generated.h"

class SRotary_RetainerWidget;


UCLASS(DisplayName="Rotary Retainer Box")
class ROTARY_API URotary_RetainerBox : public UContentWidget {
	GENERATED_BODY()

public:
	URotary_RetainerBox(FObjectInitializer const& init);
...
protected:
	TSharedPtr<SRotary_RetainerWidget> m_Widget;
};
