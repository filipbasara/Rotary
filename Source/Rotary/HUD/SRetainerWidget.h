...
DECLARE_MULTICAST_DELEGATE(FRotary_OnRetainedModeChanged);

class ROTARY_API SRotary_RetainerWidget
	: public SCompoundWidget
	, public FSlateInvalidationRoot
{
private:
	using Self = SRotary_RetainerWidget;
	using Super = SCompoundWidget;
	using RenderResources = FRotary_RenderResources;
	
public:
	static int32 s_MaxRetainerWorkPerFrame;

	SLATE_BEGIN_ARGS(SRotary_RetainerWidget)
	{
...
private:
	...
	static FRotary_OnRetainedModeChanged s_OnRetainedModeChangedDelegate;
#endif
