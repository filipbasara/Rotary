...
#define LOCTEXT_NAMESPACE "Rotary"
#define Self URotary_RetainerBox

namespace {
static FName g_DefaultTextureParamName = "Texture";
}

Self::URotary_RetainerBox(FObjectInitializer const& init)
	: Super(init)
...
{
	m_Widget = SNew(SRotary_RetainerWidget)
...
{
	return LOCTEXT("Rotary", "Rotary-Wing Aircraft");
}
#endif
