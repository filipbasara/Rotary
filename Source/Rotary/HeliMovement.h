...
struct ROTARY_API FRotary_RotorSetup {
	GENERATED_BODY()
...
class ROTARY_API URotary_HeliMovementComponent : public UPawnMovementComponent {
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category="VehicleSetup")
	TArray<FRotary_RotorSetup> Rotors;
